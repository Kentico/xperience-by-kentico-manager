...
namespace Xperience.Manager.Services
{
    public interface ISqlExecutor : IService
    {
        ...
        Task<IEnumerable<JObject>> ExecuteQuery(string connectionString, string queryText);
        ...
        /// </summary>
        /// <param name="connectionString">The connection string.</param>
        /// <param name="queryText">The name of the SQL file in the ~/Scripts folder, without the extension.</param>
